            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 mt-4 text-gray-700">Thông Tin Hóa Đơn Trả Hàng Nhập</h1>
                        <div class="card shadow" style="width: 100%;">
                            <div class="card-body " >
                                <div class="container" >
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="cid">Mã Trả Hàng : ${id}</label>
                                            <input type="hidden" class="form-control card " name="cid" id="exampleInputEmail1" placeholder="Nhập tên khách hàng" value ="${cid}">
                                        </div>  
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="cid">Tên Nhà Phân Phối: ${Refaud.sid}</label>
                                            <input type="hidden" class="form-control card " name="cid" id="exampleInputEmail1" placeholder="Nhập tên khách hàng" value ="${cid}">
                                        </div>  
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="cid">Tổng Hóa Đơn : <fmt:formatNumber value = "${Refaud.total}" type = "currency"/>
                                            </label>
                                            <input type="hidden" class="form-control card " name="cid" id="exampleInputEmail1" placeholder="Nhập tên khách hàng" value ="${cid}">
                                        </div>  
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="cid">Đã Ngày Trả Hàng: ${Refaud.daterefaud} </label>
                                            <input type="hidden" class="form-control card " name="cid" id="exampleInputEmail1" placeholder="Nhập tên khách hàng" value ="${cid}">
                                        </div>  
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered as" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <c:choose>
                                                <c:when test="${requestScope.detailrefaud.size()==0}">
                                                    Danh sánh rỗng!
                                                </c:when>
                                                <c:otherwise>
                                                    <c:forEach items="${detailrefaud}" var ="p">
