            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 mt-4 text-gray-800">Khách Trả Hàng</h1>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered as" id="dataTable" width="1000%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <c:otherwise>
                                                <c:forEach items="${requestScope.refauds}" var="r">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="deleterefaud?id=${s.bid}" onclick="return confirm('Bạn có chắc là muốn xóa hóa đơn này không?')">Xóa</a></td>
                                                    </tr>
