            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 mt-4 text-gray-700">Thông Tin Hóa Đơn Trả Hàng</h1>
                        <div class="card shadow" style="width: 100%;">
                            <div class="card-body " >
                                <div class="container" >
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="cid">Tên Khách Hàng : ${Refaud.cid}</label>
                                            <input type="hidden" class="form-control card " name="cid" id="exampleInputEmail1" placeholder="Nhập tên khách hàng" value ="${cid}">
                                        </div>  
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="cid">Ngày Trả Hàng: ${Refaud.daterefaud} </label>
                                            <input type="hidden" class="form-control card " name="cid" id="exampleInputEmail1" placeholder="Nhập tên khách hàng" value ="${cid}">
                                        </div>  
                                    </div>
