                                        ...
                                        <div class="col-md-8 ">
                                            <form action="editsupplier" method ="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control card" name="email" id="exampleInputEmail1" placeholder="Nhập email" value ="${supplier.getEmail()}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="phone">Số Điện Thoại :</label>
                                                    <input type="text" class="form-control card" name="phone" id="exampleInputEmail1" placeholder="Nhập số điện thoại" value ="${supplier.getPhone() }">
                                                </div>
